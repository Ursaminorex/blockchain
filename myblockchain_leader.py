...
def register_nodes():
    values = request.get_json()
    # values = {"nodes":["http://192.168.1.107:5000"]}
...
if __name__ == '__main__':
    ...
    try:
        ...
        print ("Error: 无法启动线程broadcast_client")
        print ("%s" %ex)
    
    time.sleep(1)

    try:
        _thread.start_new_thread( do_mine_continus, () )
    except Exception as ex:
        print ("Error: 无法启动线程do_mine_continus")
        print ("%s" %ex)
